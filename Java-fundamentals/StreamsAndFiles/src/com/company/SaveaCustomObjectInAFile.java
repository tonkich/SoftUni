...
public class SaveaCustomObjectInAFile {
    ...
    private static Course loadObject(Course course) {
        ...
        try(ObjectInputStream source = new ObjectInputStream(new FileInputStream("E:\\JavaHomework\\Streams-and-Files\\src\\com\\company\\course.save"))) {
    ...
    private static void saveObject(Course course) {
        try(ObjectOutputStream destination = new ObjectOutputStream(new FileOutputStream("E:\\JavaHomework\\Streams-and-Files\\src\\com\\company\\course.save"))) {
